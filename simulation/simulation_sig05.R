...
for(rand in c(2:RAND)){
  tryCatch({
    ...
    saveRDS(m1_ramsay, "simresult_compare/m1_05.rds")
    saveRDS(m2_twostep, "simresult_compare/m2_05.rds")
    saveRDS(m3_integrated, "simresult_compare/m3_05.rds")
